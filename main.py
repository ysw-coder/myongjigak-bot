...
BOT_USER_ID = None  # 봇 자기 자신의 슬랙 ID (시작 시 자동 조회)
...
def get_thread_history(client, channel, thread_ts, exclude_ts=None, max_msgs=20):
    """
    스레드의 이전 메시지들을 대화 형태로 변환
    exclude_ts: 현재 메시지(이미 처리 중인 것)는 제외
    """
    global BOT_USER_ID
